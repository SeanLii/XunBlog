# XunBlog v4 Canonical Path Migration

本文件只列出 v4 中发生 ownership 调整、需要网站更新 canonical route / redirect / internal link 的主要路径。

> 建议 Codex：以 `CONTENT_INDEX.md` 为最终 canonical truth；本表用于迁移旧链接。

| Old / Previous Path | v4 Canonical Path | Reason |
|---|---|---|
