...
> **知识边界**：本文的 canonical 对象是 **Linear Transformation**。依赖机制由 [Vector](/mathematics/linear-algebra/vector/)、[Matrix](/mathematics/linear-algebra/matrix/) 的 canonical page 定义；本文只在当前语境中调用其接口。
