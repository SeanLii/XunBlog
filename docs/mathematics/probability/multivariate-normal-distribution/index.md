...
> **知识边界**：本文的 canonical 对象是 **Multivariate Normal Distribution**。依赖机制由 [Normal Distribution](/mathematics/probability/normal-distribution/)、[Covariance](/mathematics/probability/covariance/)、[Matrix](/mathematics/linear-algebra/matrix/) 的 canonical page 定义；本文只在当前语境中调用其接口。
