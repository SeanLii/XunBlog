...
> **知识边界**：本文的 canonical 对象是 **Evidence Lower Bound**。依赖机制由 [Variational Inference](/mathematics/probability/variational-inference/)、[KL Divergence](/mathematics/information-theory/kl-divergence/) 的 canonical page 定义；本文只在当前语境中调用其接口。
