...
Multi-Head Attention 把一次 [Scaled Dot-Product Attention](/deep-learning/transformer/scaled-dot-product-attention/) 拆成多个并行 heads。每个 head 都有自己的 Q/K/V projections，因此可以在不同 learned subspaces 中建立不同的信息读取关系。
