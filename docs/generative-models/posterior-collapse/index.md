...
Posterior Collapse 是 latent-variable models，尤其 [Variational Autoencoder](/generative-models/variational-autoencoder/) 中的一种 failure mode：模型学会几乎不使用 latent variable $z$。
